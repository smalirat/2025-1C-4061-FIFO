...
public class QuadPrimitive
{
    ...
    private void CreateVertexBuffer(GraphicsDevice graphicsDevice)
    {
        ...
        var textureCoordinateLowerLeft = XnaVector2.Zero;
        var textureCoordinateLowerRight = XnaVector2.UnitX;
        var textureCoordinateUpperLeft = XnaVector2.UnitY;
        var textureCoordinateUpperRight = XnaVector2.One;

        var vertices = new[]
        {
            // Possitive X, Possitive Z
            new VertexPositionNormalTexture(XnaVector3.UnitX + XnaVector3.UnitZ, XnaVector3.Up, textureCoordinateUpperRight),
            // Possitive X, Negative Z
            new VertexPositionNormalTexture(XnaVector3.UnitX - XnaVector3.UnitZ, XnaVector3.Up, textureCoordinateLowerRight),
            // Negative X, Possitive Z
            new VertexPositionNormalTexture(XnaVector3.UnitZ - XnaVector3.UnitX, XnaVector3.Up, textureCoordinateUpperLeft),
            // Negative X, Negative Z
            new VertexPositionNormalTexture(-XnaVector3.UnitX - XnaVector3.UnitZ, XnaVector3.Up, textureCoordinateLowerLeft)
        };
