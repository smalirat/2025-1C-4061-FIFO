...
public class BoxPrimitive
{
    ...
    private void CreateVertexBuffer(GraphicsDevice graphicsDevice, XnaVector3 size)
    {
        ...
        Vertices = new VertexBuffer(graphicsDevice, VertexPositionNormalTexture.VertexDeclaration, vertices.Length, BufferUsage.None);
    ...
    private void CreateIndexBuffer(GraphicsDevice graphicsDevice)
    {
        ...
        Indices = new IndexBuffer(graphicsDevice, IndexElementSize.SixteenBits, indices.Length, BufferUsage.None);
