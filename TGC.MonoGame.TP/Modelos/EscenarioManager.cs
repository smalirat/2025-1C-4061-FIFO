...
namespace TGC.MonoGame.TP.Escenarios
{
    public class EscenarioManager
    {
        ...
        public EscenarioManager(ModelManager modelManager)
        {
            this.modelManager = modelManager;
        }

        public void DrawAllLevels(GraphicsDevice graphics, Matrix view, Matrix projection)
        {
            random = new Random(RANDOM_SEED);

            DrawLevel1(graphics, view, projection);
            DrawLevel2(graphics, view, projection);
            DrawLevel3(graphics, view, projection);
            DrawLevel4(graphics, view, projection);
            DrawLevel5(graphics, view, projection);
        }

        private void DrawLevel1(GraphicsDevice graphics, Matrix view, Matrix projection)
        {
        ...
        private void DrawLevel2(GraphicsDevice graphics, Matrix view, Matrix projection)
        {
        ...
        private void DrawLevel3(GraphicsDevice graphics, Matrix view, Matrix projection)
        {
            // Posicion global del nivel
        ...
        private void DrawLevel4(GraphicsDevice graphics, Matrix view, Matrix projection)
        {
            // Posicion y rotacion global del nivel
        ...
        private void DrawLevel5(GraphicsDevice graphics, Matrix view, Matrix projection)
        {
            // Posicion y rotacion global del nivel
