...
namespace TGC.TP.FIFO.Cameras
{
    ...
    class FreeCamera
    {
        ...
        private XnaVector2 _pastMousePosition;
        ...
        public XnaVector3 RightDirection { get; set; }
        ...
        public FreeCamera(float aspectRatio, XnaVector3 position, Point screenCenter)
        {
            _lockMouse = true;
            ...
            Projection = XnaMatrix.CreatePerspectiveFieldOfView(FieldOfView, AspectRatio, NearPlane, FarPlane);
            _pastMousePosition = Mouse.GetState().Position.ToVector2();
            UpdateCameraVectors();
            CalculateView();
        }

        public FreeCamera(float aspectRatio, XnaVector3 position)
        {
            AspectRatio = aspectRatio;
            Position = position;
            FieldOfView = DefaultFieldOfViewDegrees;
        ...
        private void UpdateCameraVectors()
        {
            ...
            FrontDirection = XnaVector3.Normalize(tempFront);
            RightDirection = XnaVector3.Normalize(XnaVector3.Cross(FrontDirection, XnaVector3.Up));
            UpDirection = XnaVector3.Normalize(XnaVector3.Cross(RightDirection, FrontDirection));
        }
